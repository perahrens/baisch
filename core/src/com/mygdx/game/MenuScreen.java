...
public class MenuScreen extends AbstractScreen {
	...
	public MenuScreen(final Game game) {
		...
		logoImage.setPosition((MyGdxGame.WIDTH-logoImage.getWidth())/2f, 0.9f*MyGdxGame.HEIGHT-logoImage.getHeight());
		//welcome.setPosition((MyGdxGame.WIDTH-welcome.getWidth())/2f,0.9f*MyGdxGame.HEIGHT);
		//userName.setPosition((MyGdxGame.WIDTH-userName.getWidth())/2f, 0.7f*MyGdxGame.HEIGHT);
