...
/**
 * iOS implementation of SocketClient wrapping the socket.io-client Java library.
 * Identical to the Android/desktop implementations — the same jar works under RoboVM.
 */
public class IOSSocketClient implements SocketClient {

    private final Socket socket;

    public IOSSocketClient(String url) throws Exception {
